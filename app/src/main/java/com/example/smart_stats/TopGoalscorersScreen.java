...
public class TopGoalscorersScreen extends AppCompatActivity {

    Bundle data; // instantiates data as a Bundle data-type
    String value; // instantiates string value
    ArrayList<String> topGoalScorers;// = instantiates a string array to be used in the array adapter.
    ArrayList<String> backUp;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_top_goalscorers_screen);

        leagues();

        topGoalScorers = new ArrayList<>();
    ...
    public void addPlayerToDatabase(String league, playerDetails player) {
        ...
        reference.child("Top Goalscorers").child(formattedName).setValue(player);
    }
    ...
    public void apiCall(int leagueID, String league) {
        ...
        Request request = new Request.Builder()
                .url("https://api-football-v1.p.rapidapi.com/v3/players/topscorers?league=" + leagueID + "&season=" + formattedYear)
                .get()
        ...
        call.enqueue(new Callback() {
            ...
            public void onResponse(@NonNull Call call, @NonNull Response response) throws IOException {
                ...
                try {
                    ...
                    TopGoalscorersScreen.this.runOnUiThread(() -> {
                        ...
                        try {
                            for (int i = 0; i < responseArray.length(); i++) {
                                ...
                                JSONObject goals = (JSONObject) stats_index_playerGoals.getJSONObject(0).getJSONObject("goals");
                                String playerGoals = goals.getString("total");

                                topGoalScorers.add("Name: " + playerName + "\nTeam: " + teamName + "\nGames Played: " + gamesPlayed + "\nGoals: " + playerGoals);

                                playerDetails playerDB = new playerDetails(playerName, teamName, gamesPlayed, playerGoals);
                        ...
                        listBuilder(topGoalScorers, league);
    ...
    public void listBuilder(ArrayList<String> liveMatches, String league) {
        ...
        if (!liveMatches.isEmpty()) {
            ...
            ListView listViewDB = findViewById(R.id.listViewTopGoalscorers);
            ...
            ListView listViewAPI = findViewById(R.id.listViewTopGoalscorers);
